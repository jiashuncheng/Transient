...
def add_basic_cli_args(p: ArgumentParser):
    ...
    p.add_argument("--train_dir", default=os.path.abspath(os.path.join(os.path.abspath(os.path.dirname(__file__)), "../../train_dir")), type=str, help="Root for all experiments")
    p.add_argument(
        "--restart_behavior",
        default="resume",
    ...
    p.add_argument(
        ...
        default='0',
        type=str,
        help="Choice the gpu id",
    )
    p.add_argument("--seed", default=None, type=int, help=" ")
    p.add_argument("--distraction", default=0, type=int, help=" ")
    p.add_argument("--w", default=1, type=int, help=" ")
...
def add_rl_args(p: ArgumentParser):
    ...
    p.add_argument("--learning_rate_final", default=1e-5, type=float, help="LR")
    p.add_argument(
        "--lr_schedule",
        default="constant",
...
def add_model_args(p: ArgumentParser):
    ...
    p.add_argument(
        "--rnn_type",
        default="gru",
        choices=["gru", "lstm", "trnn", "rnn", "gtrnn"],
        type=str,
    ...
    p.add_argument(
        ...
        default=0.1,
        type=float,
        help="Initial value for TRNN, alpha",
    )
    p.add_argument(
        "--gate",
        default=1,
        type=int,
        help="Initial value for TRNN, theta gate",
    )
    p.add_argument(
        "--sig_m",
        default=0,
    ...
    p.add_argument(
        ...
        default=0,
        type=int,
        help="Initial value for TRNN, 0->linear network",
    )
    p.add_argument(
        "--region",
        default=1,
        type=int,
        help="Initial value for TRNN, region"
    )
...
def add_default_env_args(p: ArgumentParser):
    ...
    default=10, 
    type=int,
    help="Number of the command_cound in Mortar enviroment")

    p.add_argument("--size", default=11, type=int, help=" ")
    p.add_argument("--agent_view_size", default=5, type=int, help=" ")
    p.add_argument("--delay", default=14, type=int, help=" ")
...
def add_eval_args(parser):
    ...
    parser.add_argument("--mm_render", action="store_true", help="Render in the mortar mayhem enviroment")
    parser.add_argument(
        "--video_frames",
        default=1e9,
        type=int,
