...
class GridMortarMayhemEnv(CustomEnv):
    ...
    def _generate_command_visualization(self, commands, duration=1, delay=0):
        ...
        """
        command_vis = []
        if self.distraction == 3:
            pass
        if self.distraction == 2:
            commands[3] = ""
        if self.distraction == 1:
            commands[2] = ""
            commands[3] = ""
        if self.distraction == 0:
            commands[1] = ""
            commands[2] = ""
            commands[3] = ""
    ...
    def reset(self, seed = None, return_info = True, options = None, distraction=0):
