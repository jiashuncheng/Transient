...
from examples.direction_following.experiments.env import GridMortarMayhemEnv

os.environ["PYGAME_HIDE_SUPPORT_PROMPT"] = "hide"

class DFShapingWrapper(gym.Env):
    ...
    def reset(self, **kwargs):
        ...
        vis_obs, info = self._env.reset(seed=self._seed, options=options, distraction=self.cfg.distraction)
