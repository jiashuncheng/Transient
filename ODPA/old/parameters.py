...
par = {
    'seed'                  : args.seed,
    # Setup parameters
    'save_dir'              : os.path.join(cur_file_path.parent,'savedir/'),
    'save_fn'               : None, # shorten_delay   _400   increase_neurons  
    'save_fn1'              : None,
...
def update_dependencies():
    ...
    par['w_in0']  *= par['w_in_mask'] * 0.3 # jia
    par['w_rnn0'] *= par['w_rnn_mask'] * 0.3 # jia
    par['w_out0'] *= par['w_out_mask'] * 0.3 # jia
