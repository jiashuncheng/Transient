...
def args(i):
    _args = ["--exp", "0127_0.01_auto_noise_trasient_sparse_con_{}".format(list_[i][0]), "--delay", "6", "--gpu", "1", "--num_iterations", "1000", "--seed", "0", "--mode", "train", "--transient", "True", "--connection_prob", "{}".format(list_[i][0]), "--regions", "False", "--hidden_num", "120", "--noise_h", "True", "--lr", "0.01"]
    return _args
