...
list_ = [[0.2, 1], [0.4, 1], [0.6, 1], [0.8, 1], [1, 1], [2, 1], [4, 1], [6, 1], [8, 1],\
         [0.2, 2], [0.4, 2], [0.6, 2], [0.8, 2], [1, 2], [2, 2], [4, 2], [6, 2], [8, 2],\
         [0.2, 4], [0.4, 4], [0.6, 4], [0.8, 4], [1, 4], [2, 4], [4, 4], [6, 4], [8, 4]]
# list_ = [[2, 4], [2, 5], [2, 6], [2, 7], [2, 8], [2, 9], [2, 10],\
#          [4, 1], [4, 2], [4, 3], [4, 4], [4, 5], [4, 6], [4, 7], [4, 8], [4, 9],\
#          [6, 0.5], [6, 0.6], [6, 0.7], [6, 0.8], [6, 0.9], [6, 1], [6, 1.2], [6, 1.4], [6, 1.6]]

def args(i):
    _args = ["--exp", "v12", "--delay", "6", "--gpu", "1", "--num_iterations", "1000", "--seed", "4", "--mode", "train", "--transient", "True", "--connection_prob", "1.0", "--regions", "False", "--hidden_num", "600", "--noise_h", "True", "--lr", "0.001", "--save_model", "--in_", "True", "--out", "True", "--v_m", "{}".format(list_[i][0]), "--v_gamma", "{}".format(list_[i][1]), "--scale", "1", "--batch_size", "64", "--alpha", "0.6"]
    return _args
