...
class Model:
    ...
    def rnn_cell(self, rnn_input, h, syn_x, syn_u, theta):
        ...
        if self.tran:
            ...
            theta = (1-self.dt_tau_v) * theta + F.relu(self.m) * self.dt_tau_v * h #抑制强度
...
if __name__ == '__main__':
    ...
    name = 'delay{}'.format(60000)
    delay_ = 6
    main(name, delay_, 0,  gpu_id = 3)