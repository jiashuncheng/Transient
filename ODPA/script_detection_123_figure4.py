...
# m = [5.5, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10]
...
def args(i):
    _args = ["--exp", "v24.2_123", "--delay", "6", "--gpu", "1", "--num_iterations", "1000", "--seed", "2", "--mode", "train", "--transient", "True", "--connection_prob", "{}".format(list_[i][1]), "--regions", "True", "--hidden_num", "600", "--noise_h", "True", "--lr", "0.001", "--save_model", "--in_", "True", "--out", "True", "--v_m", "{}".format(list_[i][0]), "--v_gamma", "1", "--scale", "1", "--batch_size", "64", "--alpha", "0.6"]
    return _args
