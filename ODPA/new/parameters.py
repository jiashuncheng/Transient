...
par = {
    ...
    'tau_r'                 : 100,
    'v_m'                   : args.v_m,
    'v_gamma'               : args.v_gamma,

    # Training specs 
    'batch_size'            : args.batch_size, # 1024
    'num_iterations'        : 1000,
    'iters_between_outputs' : 10, # 100
    'iters_between_save_model' : 100,
...
def update_dependencies():
    ...
    par['alpha_neuron'] = args.alpha #np.float32(par['dt'])/par['membrane_time_constant']
    ...
    par['w_in0'] *= args.scale
    par['w_rnn0'] *= args.scale
    par['w_out0'] *= args.scale
